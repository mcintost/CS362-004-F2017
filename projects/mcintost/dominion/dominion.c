...
//Added functions for cards outside of the switch.

//Smithy function
void smithy_card(int currentPlayer, struct gameState *state, int handPos)
{
	int i = 0;
	//Only draws 2 cards instead of 3.
	for (i = 0; i < 2; i++)
	{
...
//Adventurer Function
void adventurer_card(int currentPlayer, struct gameState *state, int handPos)
{
	int drawntreasure = 0;
	int cardDrawn;
	int temphand[MAX_HAND];
	int z = 0;
	//changed the number of treasures drawn from 2 to 1. (Fixed the bug returning the value to 2.)
...
//Great hall Function
void greathall_card(int currentPlayer, struct gameState *state, int handPos)
{      
	//+1 Card
	drawCard(currentPlayer, state);
...
//Steward Function
void steward_card(int currentPlayer, struct gameState *state, int handPos, int choice1, int choice2, int choice3)
{
	if (choice1 == 1)
	{
		//+2 cards
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
	...
	//Call the adventuer function.
	adventurer_card(currentPlayer, state, handPos);
    return 0;
    ...
    case great_hall:
	    //call the greathall function
		greathall_card(currentPlayer, state, handPos);
        return 0;
